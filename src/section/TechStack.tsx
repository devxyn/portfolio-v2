...
import { techStackImgs } from "../constants/data";
// import TechIcon from "../components/models/tech-logo/TechIcon";
        ...
        <div className='tech-grid'>
          ...
          {techStackImgs.map((techStackIcon, index) => (
            <div key={index} className='card-border tech-card overflow-hidden group xl:rounded-full rounded-lg'>
              ...
              <div className='tech-card-content'>
                <div className='tech-icon-wrapper'>
                  <img src={techStackIcon.imgPath} alt={`${techStackIcon.name} logo`} className='h-20 w-20' />
                </div>
                <div className='padding-x w-full'>
                  <p>{techStackIcon.name}</p>
                </div>
